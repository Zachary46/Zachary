    ...
    private static File getExternalCacheDirectory(Context context, String type) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            ...
            if (appCacheDir == null) {// 有些手机需要通过自定义目录
                appCacheDir = new File(Environment.getExternalStorageDirectory(), "Android/data/" + context
                        .getPackageName() + "/cache/" + type);
            }
            ...
            Log.e("getExternalDirectory", "getExternalDirectory fail ,the reason is sdCard nonexistence or sdCard " +
                    "mount fail !");
        }
        return appCacheDir;
    }
